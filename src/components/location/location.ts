import { TheCountrySelect } from "src/shared/components/form/inputs/TheCountrySelect";
...
try {
return await fetch("http://ip-api.com/json").then((response) =>response.json()).then((data:IPLookupResponse) => data)
} catch (error) {
throw error
}
}
